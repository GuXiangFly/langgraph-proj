...
def setup_environment():
    ...
    if os.environ.get('MODEL_PATH') is None:
        # os.environ['MODEL_PATH'] = '/nfs/volume-807-1/guxiang/modelhub/Qwen/Qwen3-Embedding-4B'
        os.environ['MODEL_PATH'] = '/Users/didi/dev/softwareworkspace/modelhub/Qwen/Qwen3-Embedding-0.6B'
...
if __name__ == "__main__":
    ...
    parser.add_argument("--port", type=int, default=8019, help="监听端口 (默认: 8000)")
